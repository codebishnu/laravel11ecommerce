...
<head>
  ...
  <meta name="author" content="OnlineShop" />
                ...
                <div class="section-content-right">
                    ...
                    @yield('content')
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2024 OnlineShop</div>
                        </div>
                    </div>
              ...
              <li>
                  <ul>
                    <li class="product-item gap14 mb-10">
                        ...
                        <div class="flex item-center justify-betweem gap20 flex-grow">
                        <div class="name">
