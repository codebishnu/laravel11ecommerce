    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{ route('admin.brand.update')}}" method="post"
                ...
                @error('name') <span class="alert alert-danger text-center">{{$message}}
                </span>
                @enderror
                ...
                @error('slug') <span class="alert alert-danger text-center">{{$message}}
                </span> @enderror
                ...
                @error('image') <span class="alert alert-danger text-center">{{$message}}
                </span>
                @enderror
                <div class="bot">
                    <div></div>
