...
class AdminController extends Controller
{
    ...
    {
        // Display Admin Dashboard No of amount and canceled
        //and orders 
   ...
   public function category_delete($id)
{
  ...
  public function product_edit($id)
  {
    ...
    public function coupon_delete($id)
    {
            $coupon = Coupon::find($id);        
            $coupon->delete();
            return redirect()->route('admin.coupons')->with('status','Coupons has been deleted successfully !');
    }
    ...
    public function GenerateSlideThumbnailImage($image, $imageName){
        ...
        {
            $slide = Slide::find($id);
            return view('admin.slide-edti',compact('slide'));
        }
